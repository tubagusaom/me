            ...
            <div id="panel-cart-discount" class="accordion-body collapse in">
              <div class="panel-body">
                ...
                <ul class="products-grid columns4">
                  ...
                  <?php
                    foreach ($mobil_favorit as $key => $mobil) {

                      $jam_awal=$mobil->jam_awal;
                      $jam_akhir=$mobil->jam_akhir;
                  ...
                  <li>
                      ...
                      <figure class="product-image-area">
                        <a href="<?=base_url()?>favorit/detail/<?=$mobil->id ?>" title="BIDDING" class="product-image">
                          <span class="product-image-text">
                            <img style="width: 40%" src="<?php echo base_url().'_assets/img/bidding_white.png' ?>" class="m-auto-tb" alt="<?=$aplikasi->nama_unit?>">
                          </span>
                          <span class="product-bidding-text">
                            BIDDING
                          </span>
      										<img class="product-bidding-image image-tb" src="<?=base_url()?>assets/files/member/<?=$mobil->file_komponen?>" alt="Product Name">
                        </a>
    									</figure>
