<ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 30px">
    ...
    <li class="nav-item  <?= $this->uri->segment(1) == 'data-member' ? 'active' : '' ?>">    <a href="javascript:;" class="nav-link nav-toggle">
            <i class="icon-layers"></i>
            <span class="title">Penugasan</span>
            <span class="arrow"></span>
        </a>
        <ul class="sub-menu">
            <li class="nav-item  <?= $this->uri->segment(1) == 'data-member' ? 'active' : '' ?>">
                <a href="<?= base_url() . 'data-member' ?>" class="nav-link ">
