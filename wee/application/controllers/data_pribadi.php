        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($data !== false) {
                if ($this->data_pribadi_model->check_unique($data)) {
                	//var_dump($this->data_pribadi_model->update($id, $data));
        	...
        	$this->load->library('combogrid');
                ...
                $lampiran_cv = $this->combogrid->set_properties(array('model'=>'repositori_model', 'controller'=>'combo_files', 'fields'=>array('nama_dokumen','file_size'), 'options'=>array('id'=>'lampiran_cv', 'pagination', 'rownumber', 'idField'=>'id', 'textField'=>'nama_dokumen', 'panelWidth'=>500,
                    'queryParams'=>array('name'=>'easui') 
                    )))->load_model()->set_grid();
                $lampiran_surat_pernyataan = $this->combogrid->set_properties(array('model'=>'repositori_model', 'controller'=>'combo_files', 'fields'=>array('nama_dokumen','file_size'), 'options'=>array('id'=>'lampiran_surat_pernyataan', 'pagination', 'rownumber', 'idField'=>'id', 'textField'=>'nama_dokumen', 'panelWidth'=>500,
                    'queryParams'=>array('name'=>'easui') 
                    )))->load_model()->set_grid();
                $lampiran_pakta_integritas = $this->combogrid->set_properties(array('model'=>'repositori_model', 'controller'=>'combo_files', 'fields'=>array('nama_dokumen','file_size'), 'options'=>array('id'=>'lampiran_pakta_integritas', 'pagination', 'rownumber', 'idField'=>'id', 'textField'=>'nama_dokumen', 'panelWidth'=>500,
                    'queryParams'=>array('name'=>'easui') 
                    )))->load_model()->set_grid();
                $lampiran_seraskom = $this->combogrid->set_properties(array('model'=>'repositori_model', 'controller'=>'combo_files', 'fields'=>array('nama_dokumen','file_size'), 'options'=>array('id'=>'lampiran_seraskom', 'pagination', 'rownumber', 'idField'=>'id', 'textField'=>'nama_dokumen', 'panelWidth'=>500,
                    'queryParams'=>array('name'=>'easui') 
                    )))->load_model()->set_grid();
                $lampiran_serkom1 = $this->combogrid->set_properties(array('model'=>'repositori_model', 'controller'=>'combo_files', 'fields'=>array('nama_dokumen','file_size'), 'options'=>array('id'=>'lampiran_serkom1', 'pagination', 'rownumber', 'idField'=>'id', 'textField'=>'nama_dokumen', 'panelWidth'=>500,
                    'queryParams'=>array('name'=>'easui') 
                    )))->load_model()->set_grid();
            ...
            $view = $this->load->view('data_pribadi/add', array('akun'=>$this->auth->get_user_data()->akun,'files'=>$files
                ,
                'lampiran_cv'=>$lampiran_cv,
                'lampiran_surat_pernyataan'=>$lampiran_surat_pernyataan,
                'lampiran_pakta_integritas'=>$lampiran_pakta_integritas,
                'lampiran_seraskom'=>$lampiran_seraskom,
                'lampiran_serkom1'=>$lampiran_serkom1,
                'user_id'=>$user_id,'profil_asesor' => $profil_asesor, 'url' => base_url() . 'data_pribadi/upload/' . $profil_asesor->id,'sex'=>array('','Laki-Laki','Perempuan')), TRUE);
